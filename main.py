...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def construct_mag_phase(self,imagearr):
        Image.fromarray(imagearr.astype(np.uint8)).save('mixedoutput.png')
        self.mixed_output = QPixmap('mixedoutput.png')
        return self.mixed_output
    def construct_real_img(self,imagearr):
        Image.fromarray(imagearr.astype(np.uint8)).save('mixedoutput.png')
        self.mixed_output = QPixmap('mixedoutput.png')
        return self.mixed_output
    def component_selection(self,comp1,comp2):
        ...
        if self.choose_comp1.currentText() == "Image1" and self.choose_comp2.currentText() == "Image1":
            if comp1 == "Magnitude" or comp2 == "Magnitude":
                self.output_image_arr = self.image1.mix(self.image1,self.percentages[0].value(),self.percentages[1].value(),Modes.magnitudeAndPhase)
                self.output_image = self.construct_mag_phase(self.output_image_arr)
            if comp1 == "Real" or comp2 == "Real":
                self.output_image_arr = self.image1.mix(self.image1,self.percentages[0].value(),self.percentages[1].value(),Modes.realAndImaginary)
                self.output_image=self.construct_real_img(self.output_image_arr)
            if (comp1 == "Unimagnitude" or comp2 == "Unimagnitude") and (comp1 == "Uniphase" or comp2 == "Uniphase"):
                self.output_image_arr = self.image1.mix(self.image1,self.percentages[0].value(),self.percentages[1].value(),Modes.UniMagnitudeAndUniphase)
                self.output_image = self.construct_mag_phase(self.output_image_arr)
            if (comp1 == "Unimagnitude" or comp2 == "Unimagnitude") and (comp1 == "Phase" or comp2 == "Phase"):
                self.output_image_arr = self.image1.mix(self.image1,self.percentages[0].value(),self.percentages[1].value(),Modes.UniMagnitudeAndPhase)
                self.output_image = self.construct_mag_phase(self.output_image_arr)
            if (comp1 == "Uniphase" or comp2 == "Uniphase") and (comp1 == "Magnitude" or comp2 == "Magnitude"):
                self.output_image_arr = self.image1.mix(self.image1,self.percentages[0].value(),self.percentages[1].value(),Modes.magnitudeAndUniphase)
                self.output_image = self.construct_mag_phase(self.output_image_arr)
        ...
        if self.choose_comp1.currentText() == "Image1" and self.choose_comp2.currentText() == "Image2":
            ...
            if comp1 == "Magnitude":
                self.output_image_arr = self.image1.mix(self.image2,self.percentages[0].value(),self.percentages[1].value(),Modes.magnitudeAndPhase)
                self.output_image = self.construct_mag_phase(self.output_image_arr)
            if comp2 == "Magnitude":
                self.output_image_arr = self.image2.mix(self.image1,self.percentages[0].value(),self.percentages[1].value(),Modes.magnitudeAndPhase)
                self.output_image = self.construct_mag_phase(self.output_image_arr)
            if comp1 == "Real" :
                self.output_image_arr = self.image1.mix(self.image2,self.percentages[0].value(),self.percentages[1].value(),Modes.realAndImaginary)
                self.output_image=self.construct_real_img(self.output_image_arr)
            if comp2 == "Real":
                self.output_image_arr = self.image2.mix(self.image1,self.percentages[0].value(),self.percentages[1].value(),Modes.realAndImaginary)
                self.output_image=self.construct_real_img(self.output_image_arr)
            if comp1 == "Unimagnitude" and comp2 == "Uniphase":
                self.output_image_arr = self.image1.mix(self.image2,self.percentages[0].value(),self.percentages[1].value(),Modes.UniMagnitudeAndUniphase)
                self.output_image = self.construct_mag_phase(self.output_image_arr)
            if comp1 == "Unimagnitude" and comp2 == "Phase":
                self.output_image_arr = self.image1.mix(self.image2,self.percentages[0].value(),self.percentages[1].value(),Modes.UniMagnitudeAndPhase)
                self.output_image = self.construct_mag_phase(self.output_image_arr)
            if comp1 == "Magnitude" and comp2 == "Uniphase":
                self.output_image_arr = self.image1.mix(self.image2,self.percentages[0].value(),self.percentages[1].value(),Modes.magnitudeAndUniphase)
                self.output_image = self.construct_mag_phase(self.output_image_arr)
            if comp1 == "Uniphase" and comp2 == "Unimagnitude":
                self.output_image_arr = self.image2.mix(self.image1,self.percentages[0].value(),self.percentages[1].value(),Modes.UniMagnitudeAndUniphase)
                self.output_image = self.construct_mag_phase(self.output_image_arr)
            if comp1 == "Phase" and comp2 == "Unimagnitude":
                self.output_image_arr = self.image2.mix(self.image1,self.percentages[0].value(),self.percentages[1].value(),Modes.UniMagnitudeAndPhase)
                self.output_image = self.construct_mag_phase(self.output_image_arr)
            if comp1 == "Uniphase" and comp2 == "Magnitude":
                self.output_image_arr = self.image2.mix(self.image1,self.percentages[0].value(),self.percentages[1].value(),Modes.magnitudeAndUniphase)
                self.output_image = self.construct_mag_phase(self.output_image_arr)
        ...
        if self.choose_comp1.currentText() == "Image2" and self.choose_comp2.currentText() == "Image2": 
            ...
            if comp1 == "Magnitude" or comp2 == "Magnitude":
                self.output_image_arr = self.image2.mix(self.image2,self.percentages[0].value(),self.percentages[1].value(),Modes.magnitudeAndPhase)
                self.output_image = self.construct_mag_phase(self.output_image_arr)
            if comp1 == "Real" or comp2 == "Real":
                self.output_image_arr = self.image2.mix(self.image2,self.percentages[0].value(),self.percentages[1].value(),Modes.realAndImaginary)
                self.output_image=self.construct_real_img(self.output_image_arr)
            if comp1 == "Unimagnitude" or comp2 == "Unimagnitude" and comp1 == "Uniphase" or comp2 == "Uniphase":
                self.output_image_arr = self.image2.mix(self.image2,self.percentages[0].value(),self.percentages[1].value(),Modes.UniMagnitudeAndUniphase)
                self.output_image = self.construct_mag_phase(self.output_image_arr)
            
            if comp1 == "Unimagnitude" or comp2 == "Unimagnitude" and comp1 == "Phase" or comp2 == "Phase":
                self.output_image_arr = self.image2.mix(self.image2,self.percentages[0].value(),self.percentages[1].value(),Modes.UniMagnitudeAndPhase)
                self.output_image = self.construct_mag_phase(self.output_image_arr)
            
            if comp1 == "Uniphase" or comp2 == "Uniphase" and comp1 == "Magnitude" or comp2 == "Magnitude":
                self.output_image_arr = self.image2.mix(self.image2,self.percentages[0].value(),self.percentages[1].value(),Modes.magnitudeAndUniphase)
                self.output_image = self.construct_mag_phase(self.output_image_arr)
    ...
    def check_component(self):
        ...
        if self.components_img1.currentText() == "Magnitude" :
           ...
           self.img1_comp = self.reconstruct_image(self.img1_comp)
    ...
    #image 2
        if self.components_img2.currentText() == "Magnitude" :
           ...
           self.img2_comp = self.reconstruct_image(self.img2_comp)
